...
impl EmissionSchedule {
    ...
    pub fn supply_projections(&self) -> Vec<(i64, u128, &'static str)> {
        ...
        vec![
            ...
            (
                genesis + year,
                self.total_supply_at(genesis + year),
                "Year 1 (2027)",
            ),
            (
                genesis + 4 * year,
                self.total_supply_at(genesis + 4 * year),
                "Year 4 (2030)",
            ),
            (
                genesis + 5 * year,
                self.total_supply_at(genesis + 5 * year),
                "Year 5 (2031)",
            ),
            (
                genesis + 10 * year,
                self.total_supply_at(genesis + 10 * year),
                "Year 10 (2036)",
            ),
            (
                genesis + 20 * year,
                self.total_supply_at(genesis + 20 * year),
                "Year 20 (2046)",
            ),
            (
                genesis + 50 * year,
                self.total_supply_at(genesis + 50 * year),
                "Year 50 (2076)",
            ),
        ]
    }
