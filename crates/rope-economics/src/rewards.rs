...
use crate::constants::*;
use crate::emission::{EmissionSchedule, AnchorReward};
use crate::performance::{PerformanceScore, PerformanceMultiplier, PerformanceMetrics};
...
impl RewardCalculator {
    ...
    pub fn calculate_proposer_reward(
        &self,
        validator_id: [u8; 32],
        timestamp: i64,
    ) -> u128 {
    ...
    pub fn new(
        ...
        let testimony_rewards: Vec<([u8; 32], u128)> = testimony_validators
            ...
            .map(|(id, count)| {
                ...
                let multiplier = performance_scores.get(id).map(|s| s.multiplier()).unwrap_or(1.0);
