...
mod tests {
    ...
    fn test_validator_tiers() {
        assert_eq!(
            ValidatorTier::from_stake(500_000 * ONE_FAT),
            ValidatorTier::Standard
        );
        assert_eq!(
            ValidatorTier::from_stake(1_000_000 * ONE_FAT),
            ValidatorTier::Standard
        );
        assert_eq!(
            ValidatorTier::from_stake(5_000_000 * ONE_FAT),
            ValidatorTier::Professional
        );
        assert_eq!(
            ValidatorTier::from_stake(25_000_000 * ONE_FAT),
            ValidatorTier::Enterprise
        );
        assert_eq!(
            ValidatorTier::from_stake(100_000_000 * ONE_FAT),
            ValidatorTier::Foundation
        );
    }
    ...
    fn test_stake_manager() {
        ...
        let result = manager.register_validator([1u8; 32], [2u8; 32], 1_000_000 * ONE_FAT, 0);
