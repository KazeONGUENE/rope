...
fn canonical_ai_agents() -> Vec<serde_json::Value> {
    ...
    vec![
        serde_json::json!({
            ...
            "walletKind": "canonical-agent-id",
            "signingPubkey": "0x4da77c4314a2a3f1e1084d7624376fd39814d48b4c4ae6b5ca2420f32aeb6eb1",
            "nodeId": "0xd3ffde8b70ff302eea17bdcc658b0cfccf6229931f8e3d094ba332fafb63538b",
            "signingAlgorithm": "Ed25519 + CRYSTALS-Dilithium3 (hybrid)",
            ...
            "publicHttp": true,
            "deploymentMode": "http-server",
            "testimoniesUrl": "https://dcscan.io/address/0x000000000000000000000000000000000000C001",
        ...
        serde_json::json!({
            ...
            "walletKind": "canonical-agent-id",
            "signingPubkey": "0xe503c418d10d6570ab49f12f1aa306c1750946bd85e445feee3b465e44194e57",
            "nodeId": "0x034357773bfe006cd3dd9f347d9d1ee9a6b62c3cecccf782cddc33ac5162ae51",
            "signingAlgorithm": "Ed25519 + CRYSTALS-Dilithium3 (hybrid)",
            "testimoniesCount": null,
            "uptime": "99.8%",
            ...
            "publicHttp": false,
            "deploymentMode": "background-daemon",
            "testimoniesUrl": "https://dcscan.io/address/0x000000000000000000000000000000000000C002",
        ...
        serde_json::json!({
            ...
            "walletKind": "canonical-agent-id",
            "signingPubkey": "0x534622147502b4249cd5a9589aceec8ebf1fa0920ce1c45371778546efeed718",
            "nodeId": "0x34e6edb275ac52e37fcf03cd8ae089b52012acae0cc38c5f634243adbad93748",
            "signingAlgorithm": "Ed25519 + CRYSTALS-Dilithium3 (hybrid)",
            "testimoniesCount": null,
            "uptime": "99.2%",
            "icon": "fa-umbrella",
            ...
            "publicHttp": false,
            "deploymentMode": "background-daemon",
            "testimoniesUrl": "https://dcscan.io/address/0x000000000000000000000000000000000000C003",
            "rpcMethods": ["rope_appendToLedger"],
        ...
        serde_json::json!({
            ...
            "walletKind": "canonical-agent-id",
            "signingPubkey": "0xd35bb8c04720fd095ac26185f4e283b002b2f1deb9ac1fa5cfe37cd9b0be03a1",
            "nodeId": "0xf1beed6c5ecf39db1136969693dba91818d655c2bd9b9beb69b072f33cad7a9b",
            "signingAlgorithm": "Ed25519 + CRYSTALS-Dilithium3 (hybrid)",
            "testimoniesCount": null,
            "uptime": "99.7%",
            "icon": "fa-gavel",
            ...
            "publicHttp": false,
            "deploymentMode": "background-daemon",
            "testimoniesUrl": "https://dcscan.io/address/0x000000000000000000000000000000000000C004",
            "rpcMethods": ["rope_globalStats", "rope_walkLedgerChain", "rope_appendToLedger"],
            "dataFeeds": [],
            "source": "canonical-fallback"
        }),
        serde_json::json!({
            ...
            "walletKind": "canonical-agent-id",
            "signingPubkey": "0x3e6ac4978d6bc120166850371b5f81d78b6c624d4fac9ea360e9a78fc1a3bc82",
            ...
            "publicHttp": true,
            "deploymentMode": "http-server",
            "testimoniesUrl": "https://dcscan.io/address/0x000000000000000000000000000000000000C005",
