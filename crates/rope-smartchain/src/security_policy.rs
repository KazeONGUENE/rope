...
impl SecurityPolicy {
    ...
    fn check_permission(&self, perms: &EntityPermissions, action: &ToolAction) -> bool {
        ...
        let action_allowed = match &action.action_type {
            ...
            _ => perms
                .custom_allowed
                .contains(&format!("{:?}", action.action_type)),
        };
...
impl Default for SecurityPolicy {
    fn default() -> Self {
        ...
        // Add default rules
        policy.add_rule(PolicyRule::RequireKyc {
            for_value_above: 10000.0,
        });
...
mod tests {
    ...
    fn test_security_policy() {
        ...
        let action = ToolAction {
            id: [0u8; 32],
            action_type: ToolActionType::Query {
